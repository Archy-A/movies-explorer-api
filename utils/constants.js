module.exports = Object.freeze({
    ...
    HTTP_NOT_FOUND: 'Страница не найдена! Ошибка: 404',
    ...
    REGEXPHTTP: /^(\/)[-a-zA-Z0-9:%._+~#=]{2,256}\/[-a-zA-Z0-9:%._+~#=]{2,256}/,
    REGEXPHTTP2: /^(http(s):\/\/.)[-a-zA-Z0-9:%._+~#=]{2,256}\/[-a-zA-Z0-9:%._+~#=]{2,256}/,
    FILM_DELETED: 'этот фильм успешно удален!',
    TRY_LIMITED: 'Вы превысили максимальное количество обращений к сервису: 100 раз за 24 часа!'
  });
